...
| Command                 | Use it when                                                                                                             |
| ----------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| `npm run check`         | Before declaring any change done: typecheck + lint + format check + unit/integration tests                              |
...
- Names say what a value _is_ in its context, not how it was produced:
...
- Comments explain _why_ (a constraint, a browser quirk, a deliberate
  trade-off), not _what_ the next line does.
